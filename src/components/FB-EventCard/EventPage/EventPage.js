...
const EventPage = () => {
  ...
  const events = [
    ...
    {
      id: 7,
      eventName: "Jerusalem Film Fest",
      eventDate: "2025-Mar-15",
      eventLocation: "Al-Bireh Cultural Palace, Jerusalem",
      eventImage: "/event-imgs/w2.png",
      eventDescription:
        "Showcasing international and Palestinian films with panels and networking.",
      sponsors: [
        { name: "Reflect", logo: "/event-imgs/reflect.jpeg" },
        { name: "PalBank", logo: "/event-imgs/palestinebank.jpeg" },
      ],
      ticketPrice: "$18 per day pass",
    },
    {
      id: 8,
